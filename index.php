...
<body data-spy="scroll">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top navbar-responsive" id="my-navbar" role="navigation">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse navbar-right container" id="navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                               ...
                               <li>
                                <a class="page-scroll trigger service-nav" data-panelId="#bcards" href="#bcards">Business Cards</a>
                               </li>
                               ...
                               <li class="page-scroll trigger dropdown-submenu">
                                <a href="#submenu">More products and services...</a>
                                
                                <ul class="dropdown-menu" id="submenu">
                                    <li>
                                        <a class="page-scroll trigger service-nav" data-panelId="#tags" tabindex="-1" href="#tags">Tags</a>
                                    </li>
                                    
                                    <li class="divider"></li>

                                    <li>
                                        <a class="page-scroll trigger service-nav" data-panelId="#htags" href="#htags">Hang Tags</a>
                                    </li>

                                    <li class="divider"></li>

                                    <li>
                                        <a class="page-scroll trigger service-nav" data-panelId="#labels" href="#labels">Labels</a>
                                    </li>

                                    <li class="divider"></li>

                                    <li>
                                        <a class="page-scroll trigger service-nav" data-panelId="#stickers" href="#stickers">Stickers</a>
                                    </li>

                                    <li class="divider"></li>

                                    <li>
                                        <a class="page-scroll trigger service-nav" data-panelId="#flyers" href="#flyers">Flyers</a>
                                    </li>

                                    <li class="divider"></li>

                                    <li>
                                        <a class="page-scroll trigger service-nav" data-panelId="#tshirt" href="#tshirt">T-Shirt Printing</a>
                                    </li>

                                    <li class="divider"></li>

                                    <li>
                                        <a class="page-scroll trigger service-nav" data-panelId="#mug" href="#mug">Mug Printing</a>
                                    </li>

                                    <li class="divider"></li>

                                    <li>
                                        <a class="page-scroll trigger service-nav" data-panelId="#catalog" href="#catalog">Catalog Printing</a>
                                    </li>

                                    <li class="divider"></li>

                                    <li>
                                        <a class="page-scroll trigger service-nav" data-panelId="#diary" href="#diary">Diary Printing</a>
                                    </li>

                                    <li class="divider"></li>

                                    <li>
                                        <a class="page-scroll trigger service-nav" data-panelId="#calendar" href="#calendar">Calendar Printing</a>
                                    </li>

                                    <li class="divider"></li>

                                    <li>
                                        <a class="page-scroll trigger service-nav" data-panelId="#brochure" href="#brochure">Brochure Printing</a>
                                    </li>

                                    <li class="divider"></li>

                                    <li>
                                        <a class="page-scroll trigger service-nav" data-panelId="#poster" href="#poster">Poster Printing</a>
                                    </li>

                                    <li class="divider"></li>

                                    <li>
                                        <a class="page-scroll trigger service-nav" data-panelId="#cards" href="#cards">Invitation Cards Printing</a>
                                    </li>

                                    <li class="divider"></li>

                                    <li>
                                        <a class="page-scroll trigger service-nav" data-panelId="#stationary" href="#stationary">Customised Printed Stationary Items</a>
                                    </li>
    ...
    <div class="container-fluid jumbotron jumbotron-image">
        <div class="container text-center">
            ...
            <p>
                <b>'A Complete Printing Solution'</b>
            </p>
        </div>
    </div>
    <!--Jumbotron End-->        
...
<!--                         <li data-target="#screenshot-carousel" data-slide-to="6"></li>
 ...
 -->                    </ol>
                    ...
                    <div class="carousel-inner" role="listbox">
                        ...
                        <div class="item">
                            <a href="#flex">
                                <img src="images/carousel5.jpg" alt="Image 5" class="center service-img">
                            </a>
                        </div>
                        <div class="item">
                            <a href="#magazine">
...
<!--                         <div class="item">
                            <a href="#spot">
                                <img src="images/images-(7).png" alt="Image 7" class="center service-img">
                            </a>
                        </div>
                        <div class="item">
                            <a href="#lamination">
                                <img src="images/LAM.png" alt="Image 8" class="center service-img">
                            </a>
                        </div> -->
                    </div>
    ...
    <div class="description">
        <div class="container-fluid hidden" id="offset">
            <section>
                <div class="page-header col-md-12">
        ...
        <div class="container-fluid hidden" id="graphic">
            <section>
                <div class="page-header col-md-12">
        ...
        <div class="container-fluid hidden" id="digital">
            <section>
                <div class="page-header col-md-12">
        ...
        <div class="container-fluid hidden" id="bcards">
            <section>
                <div class="page-header col-md-12">
        ...
        <div class="container-fluid hidden" id="flex">
            <section>
                <div class="page-header col-md-12">
                    <h2>Flex Printing</h2>
                </div>
        ...
        <div class="container-fluid hidden" id="magazine">
            <section>
                <div class="page-header col-md-12">
                    <h2>Magazine Printing</h2>
                </div>
                <div class="container text-center">
                    <p class="col-md-8">
        ...
        <div class="container-fluid hidden" id="spot">
            <section>
                <div class="page-header col-md-12">
                    <h2>Spot UV</h2>
                </div>
        ...
        <div class="container-fluid hidden" id="lamination">
            <section>
                <div class="page-header col-md-12">
                    <h2>Lamination and Binding</h2>
                </div>
                <div class="container text-center">
                    <p class="col-md-8">
        ...
        <div class="container-fluid hidden" id="tags">
            <section>
                <div class="page-header col-md-12">
                    <h2>Tags</h2>
                </div>
        ...
        <div class="container-fluid hidden" id="htags">
            <section>
                <div class="page-header col-md-12">
                    <h2>Hang Tags</h2>
                </div>
        ...
        <div class="container-fluid hidden" id="labels">
            <section>
                <div class="page-header col-md-12">
                    <h2>Labels</h2>
                </div>
        ...
        <div class="container-fluid hidden" id="stickers">
            <section>
                <div class="page-header col-md-12">
                    <h2>Stickers</h2>
                </div>
        ...
        <div class="container-fluid hidden" id="flyers">
            <section>
                <div class="page-header col-md-12">
                    <h2>Flyers</h2>
                </div>
        ...
        <div class="container-fluid hidden" id="tshirt">
            <section>
                <div class="page-header col-md-12">
        ...
        <div class="container-fluid hidden" id="mug">
            <section>
                <div class="page-header col-md-12">
                    <h2>Mug Printing</h2>
                </div>
        ...
        <div class="container-fluid hidden" id="catalog">
            <section>
                <div class="page-header col-md-12">
                    <h2>Catalog Printing</h2>
                </div>
                <div class="container text-center">
                    <p class="col-md-8">
        ...
        <div class="container-fluid hidden" id="diary">
            <section>
                <div class="page-header col-md-12">
                    <h2>Diary Printing</h2>
                </div>
                <div class="container text-center">
                    <p class="col-md-8">
        ...
        <div class="container-fluid hidden" id="calendar">
            <section>
                <div class="page-header col-md-12">
        ...
        <div class="container-fluid hidden" id="brochure">
            <section>
                <div class="page-header col-md-12">
        ...
        <div class="container-fluid hidden" id="poster">
            <section>
                <div class="page-header col-md-12">
        ...
        <div class="container-fluid hidden" id="cards">
            <section>
                <div class="page-header col-md-12">
        ...
        <div class="container-fluid hidden" id="stationary">
            <section>
                <div class="page-header col-md-12">
                    <h2>Customised Printed Stationary Items</h2>
                </div>
                <div class="container text-center">
                    <p class="col-md-8">
        ...
        <div class="container" id="about">
            <section>
                ...
                <div class="container" style="float: left">
                    ...
                    <p>
                    <div class="row">
                        The needs of our beloved customers that we can cater to:-<br>
                        <div class="col-md-6">
                        -> All Offset Printing <br>
                        -> Graphic designing <br>
                        -> Digital Printing <br>
                        -> Magazine Printing <br>
                        </div>
                        <div class="col-md-6">
                        -> Flex Printing <br>
                        -> Spot UV <br>
                        -> Lamination and Binding <br>
                        </div>
                    </div>
                    </p> 
                    <p>
                        Moreover, here is a list of products other than the basic services that our privileged customers can avail of:-<br />
                       ...
                       <div class="row">
                        ...
                        -> Office Calendars <br>
                        -> Invitation Cards <br>    
                        -> Other Customized Printed Stationary Items 
                        </div>
                    </p>
                </div>
            </section>
...
?>
                ...
                <div class="container text-center">
                    <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-primary pull-right" id="btnContactUs"><?php echo $form_submit_label ?>
                                    Send Message</button>
                            </div>
                        </div>
                    </form>
        ...
        <section class="footer">
            <div class="container">
                ...
                <div class="row" style="clear:both;">
                    ...
                    <h4 class="footer-headings" style="color: #fcab0e; font-family: roboto; font-weight: bold; margin-bottom: 30px; text-transform: uppercase;">Services</h4>
                        <div class="footer_dv">
                            <ul>
                               <li><a href="#services">Offset Printing</a></li>
                    ...
                    <div class="col-lg-3  col-md-3 col-sm-3">
                        <div class="footer_dv">
                            ...
                            <ul>
                               <li><a href="#services">Book Printing</a></li>
                               <li><a href="#services">Magazine Printing</a></li>
                               <li><a href="#services">Spot UV</a></li>
                               <li><a href="#services">Lamination and Binding</a></li>
                    ...
                    <div class="hidden col-lg-3  col-md-3 col-sm-3" id="products">
                        <div class="footer_dv">
                            <h4 class="footer-headings">Other Services and Products</h4>
                            <ul>
                               <li><a href="#services">Mug Printing</a></li>
                               <li><a href="#services">Official Tent and Pla Cards</a></li>
                               <li><a href="#services">Catalog Printing</a></li>
                               <li><a href="#services">Diary Printing</a></li>
                               <li><a href="#services">Calendar Printing</a></li>
                               <li><a href="#services">Brochure Printing</a></li>
                               <li><a href="#services">Poster Printing</a></li>
                               <li><a href="#services">Book Printing and Binding</a></li>
                               <li><a href="#services">Tags</a></li>
                               <li><a href="#services">Hang Tags</a></li>
                               <li><a href="#services">Flyers</a></li>
                               <li><a href="#services">Invitation Cards</a></li>
                               <li><a href="#services">Labels</a></li>
                               <li><a href="#services">Stickers</a></li>
                               <li><a href="#services">T-Shirt Printing</a></li>
                               <li><a href="#services">Custom Printed Stationary Items</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-3  col-md-3 col-sm-3">
                        <div class="footer_dv">
                            <h4 class="footer-headings">Contact us</h4>
    ...
    <!-- Latest compiled and minified JavaScript --><script src="js/bootstrap.min.js"></script>﻿
